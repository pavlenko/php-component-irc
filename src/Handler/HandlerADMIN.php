...
final class HandlerADMIN implements HandlerInterface
{
    public function __invoke(CMD $cmd, SessionInterface $sess, StorageInterface $stor): int
    {
        ...
        $sess->sendRPL(RPL::ADMIN_ME, [$sess->getServername()]);
        $sess->sendRPL(RPL::ADMIN_LOC1, [$stor->conf(Config::CFG_ADMIN_LOCATION1)]);
        $sess->sendRPL(RPL::ADMIN_LOC2, [$stor->conf(Config::CFG_ADMIN_LOCATION2)]);
        $sess->sendRPL(RPL::ADMIN_ME, [$stor->conf(Config::CFG_ADMIN_EMAIL)]);
        return 0;
    }
}
